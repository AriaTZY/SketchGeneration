...
parser.add_argument('--img',   type=str, default='sketch.png',     help='Input image file.')
...
print(transforms.ToTensor()(data).shape)
data0  = ((transforms.ToTensor()(data)-immean)/imstd).unsqueeze(0)
data1 = ((transforms.ToTensor()(data)-immean)/imstd).unsqueeze(0)
print(torch.cat((data0, data1), 0).shape)
if pw!=0 or ph!=0:
