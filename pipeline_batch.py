...
if __name__ == '__main__':
    ...
    parse.add_argument('--img', type=str, default='2007_000033', help='name of image file, no .jpg or .png needed')
    ...
    parse.add_argument('--model_vec', type=str, default='virtual_sketching/model/', help='The path to the "sketch simplification" pretrained network')
    ...
    # =====================
    # sketch convert, 3 steps
    # =====================
    img, pencil = image2pencil(args.voc, args.img, args.kernel, args.gamma)
    sketch = pencil2sketch(pencil, args.model_skt, args.cuda)
    sketch2vector('data/', 'sketch.png', args.vec_num, model_base_dir=args.model_vec)

    # Display stage-based images
    display(img, pencil, sketch)

    # Display drawing stroke
