...
C_min_stroke_len = 0.0003  # minimal stroke length threshold, if smaller than this, do not draw
...
def canvas_draw(npz_path, min_window_size, raster_size, line_mode='uniform'):
    # ==================
    # 1. load data
    # ==================
...
if __name__ == '__main__':
    ...
    npz_path = '../data/seq_data/sketch_1.npz'
    min_window_size = 32
    raster_size = 128

    strokes_x_list, strokes_y_list, strokes_w_list, strokes_length, canvas = canvas_draw(npz_path, min_window_size, raster_size)
